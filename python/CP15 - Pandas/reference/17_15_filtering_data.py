...
dfDance.loc[dfDance["Age"] > 21, "Age"] += 3
print(dfDance)

# to do that with .query, you have to do a workaround with .index and still use .loc
indices_from_query = dfDance.query("Age > 21").index
print(indices_from_query)
dfDance.loc[indices_from_query, "Age"] += 3
print(dfDance)
...
print(dfDance.query("Age > 21 and Type == 'Jazz'"))
