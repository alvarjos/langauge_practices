...
class DogPerson(Person):
    ...
    def introduce_yourself(self): # alter this
        if self.dog_list:
            ...
            print(f"Hello, my name is {self.name} and my hobby is {self.hobby} and I don't have a dog yet")
...
dog1 = Dog("Daisy", "Great Pyranese")
dog2 = Dog("Oreo", "White Huskey")
dog3 = Dog("Doug", "Golden Retriever")

dog_person1 = DogPerson("Angel", "Swimming")
dog_person2 = DogPerson("Mekeli", "Rugby")

# add the dogs to the person's list

dog_person1.dog_list.append(dog1)
dog_person1.dog_list.append(dog2)
dog_person1.dog_list.append(dog3)

# run introduce yourself
dog_person1.introduce_yourself()
