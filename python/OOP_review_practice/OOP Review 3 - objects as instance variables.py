...
class DogPerson(Person):
    ...
    def introduce_yourself(self):
        print(f"Hello, my name is {self.name} and my hobby is {self.hobby} and my dog's name is {self.dog}")
...
# make dog_person object and pass in the dog object
dog = DogPerson()

# run introduce yourself
DogPerson.introduce_yourself(dog)
