...
class DogPerson(Person):
    ...
    def introduce_yourself(self):
        print(f"Hello, my name is {self.name}, my hobby is {self.hobby} and my dog's name is {self.dog}") # get to the instance parameters by referencing self.

# make a person and a dogperson.
# person1 = Person("Angel", "Swimming")
dog_person = DogPerson("Angel", "Swimming", "Daisy") 

# run introduce_yourself() on each of the objects.
DogPerson.introduce_yourself(dog_person)
