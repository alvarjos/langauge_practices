...
my_workbook.active["B2"] = "Information System"
...
print(my_workbook.active.cell(1,2).value) # equals Department
...
print(my_workbook["Classes"].max_row) 
print(my_workbook["Classes"].max_column)

# use .save(filename = "filename.xlsx") to actually create a file
# create an excel file named example2
my_workbook.save("example2.xlsx")
my_workbook.close() # frees up your computers memory
